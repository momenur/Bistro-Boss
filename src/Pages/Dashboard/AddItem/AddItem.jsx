...
const AddItem = () => {
  ...
  const handleAddAnItem = (event) => {
    ...
    fetch("https://server-bisto-boss.vercel.app/menu", {
      method: "POST",
      headers: {
          ...
          <div className="shadow-2xl card bg-base-200">
            <div className="card-body">
              ...
              <div className="flex gap-8">
                <div className="w-full form-control">
                  ...
                  <input
                    type="text"
                    name="itemPhoto"
                    placeholder="Give Item Image URL"
                    className="input input-bordered"
                  />
                </div>
                <div className="w-full form-control">
                  ...
                  <select
                    ...
                    name="category"
                  >
                    <option className="" value="salad">
                      Salad
                    </option>
                    <option className="" value="pizza">
                      Pizza
                    </option>
                    <option className="" value="soup">
                      Soup
                    </option>
              ...
              <div className="mx-auto mt-6 ">
                <input
                  className="px-8 btn btn-primary bg-[#D1A054] hover:bg-white border-none hover:text-black"
                  type="submit"
                  value="Add an Item"
                />
              </div>
