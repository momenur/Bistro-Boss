        ...
        <div className="items-center justify-center mx-auto inner-background-authentication drop-shadow-2xl md:flex">
          <div>
            ...
            <form
              ...
              className="card shadow-none flex-shrink-0 w-full md:min-w-[450px] bg-transparent"
            >
              <div className="card-body">
                <div className="form-control">
                  <label className="label">
                    <span className="font-semibold text-black label-text">
                      Name
                    </span>
                  </label>
                  <input
                  ...
                  />
                  {errors.name && (
                    <span className="pt-2 text-yellow-500">
                      Name is required
                    </span>
                  )}
                </div>
                ...
                <div className="form-control">
                  ...
                  {errors.password?.type === "required" && (
                    <p className="pt-2 text-yellow-500">Password is required</p>
                  )}
                ...
                <div className="mt-6 form-control">
                  <input
                    className="bg-[#D1A054] py-3 text-white"
                    type="submit"
                    value="Sign Up"
                  />
                </div>
